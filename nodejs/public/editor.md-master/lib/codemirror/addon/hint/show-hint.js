...
(function (mod) {
  ...
  Completion.prototype = {
    ...
    showWidget: function (data) {
      ...
      var debounce = 0; var completion = this; var finished
      var closeOn = this.options.closeCharacters
      var startPos = this.cm.getCursor(); var startLen = this.cm.getLine(startPos.line).length
      ...
      function activity () {
        clearDebounce()
        var pos = completion.cm.getCursor(); var line = completion.cm.getLine(pos.line)
  ...
  function Widget (completion, data) {
    ...
    this.data = data
    var widget = this; var cm = completion.cm
    ...
    for (var i = 0; i < completions.length; ++i) {
      var elt = hints.appendChild(document.createElement('li')); var cur = completions[i]
    ...
    var left = pos.left; var top = pos.bottom; var below = true
    ...
    var box = hints.getBoundingClientRect(); var overlapY = box.bottom - winH
    if (overlapY > 0) {
      var height = box.bottom - box.top; var curTop = pos.top - (pos.bottom - box.top)
    ...
    cm.on('scroll', this.onScroll = function () {
      var curScroll = cm.getScrollInfo(); var editor = cm.getWrapperElement().getBoundingClientRect()
  ...
  CodeMirror.registerHelper('hint', 'auto', function (cm, options) {
    var helpers = cm.getHelpers(cm.getCursor(), 'hint'); var words
    if (helpers.length) {
  ...
  CodeMirror.registerHelper('hint', 'fromList', function (cm, options) {
    var cur = cm.getCursor(); var token = cm.getTokenAt(cur)
    var found = []
