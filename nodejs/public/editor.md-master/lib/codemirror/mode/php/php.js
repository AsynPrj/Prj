  ...
  CodeMirror.defineMode('php', function (config, parserConfig) {
    ...
    function dispatch (stream, state) {
      ...
      if (!isPHP) {
        ...
        var cur = stream.current(); var openPHP = cur.search(/<\?/); var m
        if (openPHP != -1) {
    ...
    return {
      startState: function () {
        var html = CodeMirror.startState(htmlMode); var php = CodeMirror.startState(phpMode)
        return { html: html,
          php: php,
      ...
      copyState: function (state) {
        var html = state.html; var htmlNew = CodeMirror.copyState(htmlMode, html)

        var php = state.php; var phpNew = CodeMirror.copyState(phpMode, php); var cur
