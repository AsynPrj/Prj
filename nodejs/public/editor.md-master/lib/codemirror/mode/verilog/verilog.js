  ...
  */
    ...
    return {
      ...
      indent: function (state, textAfter) {
        ...
        var ctx = state.context; var firstChar = textAfter && textAfter.charAt(0)
  ...
  function svxGenIndent (stream, state) {
    var svxindentUnit = 2
    var rtnIndent = -1; var indentUnitRq = 0; var curIndent = stream.indentation()
  ...
  CodeMirror.defineMIME('text/x-svx', {
    ...
    hooks: {
      '\\': function (stream, state) {
        var vxIndent = 0; var style = false
